...
class student:
    def __init__(self, root):
        ...
        img=Image.open(r"C:\Users\asus\OneDrive\Desktop\faec recognition system\college photos\recogniton 1.jpg")
        ...
        img1=Image.open(r"C:\Users\asus\OneDrive\Desktop\faec recognition system\college photos\face recognition2.jpg")
        ...
        img2=Image.open(r"C:\Users\asus\OneDrive\Desktop\faec recognition system\college photos\face recognition 3.jpg")
        ...
        img_left=Image.open(r"C:\Users\asus\OneDrive\Desktop\faec recognition system\college photos\student details.jpg")
        ...
        img_right=Image.open(r"C:\Users\asus\OneDrive\Desktop\faec recognition system\college photos\right side.jpg")
        img_right=img_right.resize((650,130), resample=Image.Resampling.LANCZOS)              
    ...
    def delete_data(self):
        if self.va_std_id.get()=="":
            ...
            try:
                ...
                self.fetch_data()
                conn.close()
                messagebox.showinfo("Delete","successfully deleted student detailes",parent=self.root)
            except Exception as es:
                messagebox.showerror("Error",f"Due To:{str(es)}",parent=self.root)
    #reset data
    def reset_data(self):
        ...
        self.var_year.set("select yeaar")
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="select Department" or self.var_std_name.get()=="" or self.va_std_id.get()=="":
            ...
            try:
                ...
                for x in myresult:
                    id+=1
                my_cursor.execute("update student set Dep=%s,course=%s,Year=%s,Semester=%s,Name=%s,Division=%s,Roll=%s,Gender=%s,Dob=%s,Email=%s,Phone=%s,Address=%s,Teacher=%s,Photosample=%s where student_id=%s",(                                                                                                                                                                            self.var_dep.get(),
                                                                                                                                                                            self.var_course.get(),  
                                                                                                                                                                            self.var_semester.get(),
                                                                                                                                                                            self.var_std_name.get(),
                                                                                                                                                                            self.var_year.get(),
